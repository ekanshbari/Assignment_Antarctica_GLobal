...
//------------------------------------------------------------------------------
    ...
    Lobibox.base.DEFAULTS = {
        ...
        delayToRemove: 50,                 // Time after which lobibox will be removed after remove call. (This option is for hide animation to finish)
            ...
            me.$el.on('click.lobibox', function (ev) {
                if (me.$options.onClickUrl) {
                   // window.location.href = me.$options.onClickUrl;
                	window.open(me.$options.onClickUrl,'_self');
...
function Lobibox_notify(type, options) {
